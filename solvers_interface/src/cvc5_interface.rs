...
pub fn study_correctness(problem: &CorrectnessVerification)-> (PossibleResult, Vec<String>){
    ...
    let file_name = crate::correctness_smt2_name(&problem.file_prefix, &problem.original_file, &problem.template_name, "cvc5");
...
// -------------------- timeout/cancel --------------------
    ...
    let verdict = crate::solver_verdict("CVC5", &new_file_name, stopped_by_us, &output);
